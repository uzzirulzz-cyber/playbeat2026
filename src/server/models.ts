...
import { connectDB as cachedConnectDB } from '../lib/mongodb';

// Re-export the cached connection helper so existing seed.ts imports keep working.
export const connectDB = cachedConnectDB;
