...
export const BestSellersSection: React.FC = () => {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 max-w-7xl mx-auto bg-transparent">
      ...
      {/* Info Banner */}
      <div className="mt-8 p-4 rounded-2xl bg-[#1e293b]/80 border border-[#3b82f6]/20 flex items-start gap-3">
        <Crown className="w-5 h-5 text-[#3b82f6] fill-[#3b82f6] shrink-0 mt-0.5" />
