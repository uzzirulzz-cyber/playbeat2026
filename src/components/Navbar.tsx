...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#0b1120] border-b border-slate-800 shadow-xl">
      ...
      <div className="w-full bg-[#070b14] border-b border-slate-800/80 px-3 sm:px-4 py-1.5 text-xs text-slate-300">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 text-[11px] text-slate-300 shrink-0">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-sky-400 hover:text-sky-300 transition-colors bg-sky-950/40 px-2 py-0.5 rounded-lg border border-sky-500/30"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-green-400 hover:text-green-300 transition-colors bg-green-950/40 px-2 py-0.5 rounded-lg border border-green-500/30 cursor-pointer"
            >
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-[#fcb800] to-yellow-300 text-slate-950 flex items-center justify-center font-black text-base sm:text-lg shadow-lg shadow-yellow-500/20 group-hover:scale-105 transition-transform">
              PB
            </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 sm:px-3.5 py-2 rounded-xl bg-[#fcb800] hover:bg-[#e5a700] text-slate-950 font-black text-xs cursor-pointer shadow-lg shadow-yellow-500/20 transition-transform active:scale-95"
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div
            className="absolute inset-y-0 left-0 w-[85vw] max-w-sm bg-[#0b1120] border-r border-slate-800 flex flex-col shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b border-slate-800">
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 rounded-2xl bg-gradient-to-tr from-[#fcb800] to-yellow-300 text-slate-950 flex items-center justify-center font-black text-base shadow-lg">
                  PB
                </div>
