...
export const LiveSupportAssistant: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-30 w-[calc(100vw-2rem)] sm:w-full max-w-sm rounded-3xl glass-dropdown border border-indigo-500/40 shadow-2xl overflow-hidden flex flex-col h-[70vh] sm:h-[480px] max-h-[480px] animate-in fade-in slide-in-from-bottom-5 duration-200">
