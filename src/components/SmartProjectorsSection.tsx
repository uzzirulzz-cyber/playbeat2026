          ...
          return (
            ...
            >
              ...
              <div 
                ...
                className="relative h-36 sm:h-48 w-full bg-slate-950 overflow-hidden cursor-pointer"
              >
                <img
              ...
              <div className="p-2.5 sm:p-4 flex-1 flex flex-col justify-between space-y-2 sm:space-y-3">
                <div className="space-y-1 sm:space-y-1.5">
                  <div className="flex items-center justify-between text-[10px] sm:text-[11px]">
                    ...
                    {prod.sourceUrl && (
                      <a
                        ...
                        className="text-slate-400 hover:text-white items-center gap-1 text-[10px] hidden sm:flex shrink-0"
                      >
                  ...
                  <p className="text-[10px] sm:text-xs text-slate-400 line-clamp-2 leading-relaxed hidden sm:block">
                    {prod.shortDescription}
                  </p>
                </div>

                {/* Specs Chips */}
                <div className="grid grid-cols-2 gap-1 sm:gap-1.5 text-[10px] sm:text-[11px] font-mono text-slate-300">
                  <div className="p-1 sm:p-1.5 rounded-md sm:rounded-lg bg-slate-950 border border-slate-800 truncate">
                ...
                <div className="pt-1.5 sm:pt-2 border-t border-slate-800 flex items-center justify-between gap-1.5 sm:gap-2">
                  ...
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
                    <a
                      ...
                      className="hidden sm:block p-2 rounded-xl bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-white border border-emerald-500/30 transition-all cursor-pointer"
