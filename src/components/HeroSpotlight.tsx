        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-semibold backdrop-blur-md">
              <span className="flex h-2 w-2 rounded-full bg-[#3b82f6] animate-ping" />
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-[1.15]">
              ...
              <span className="text-[#3b82f6] drop-shadow-[0_2px_12px_rgba(252,184,0,0.25)]">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              {popularKeywords.map(kw => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0f172a] hover:bg-[#1e293b] border border-slate-700/70 hover:border-blue-500/50 text-xs text-slate-300 hover:text-blue-400 transition-all cursor-pointer font-medium"
                >
                  #{kw.label}
                </button>
              ))}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3">
              <div className="p-3.5 rounded-xl bg-[#0f172a]/90 border border-slate-800">
                <div className="text-lg sm:text-xl font-black text-[#3b82f6]">99.98%</div>
              ...
              <div className="p-3.5 rounded-xl bg-[#0f172a]/90 border border-slate-800">
                <div className="text-lg sm:text-xl font-black text-blue-400">4.9 / 5.0</div>
                <div className="text-[11px] text-slate-400 font-medium">18.4k Verified Reviews</div>
              </div>
              <div className="p-3.5 rounded-xl bg-[#0f172a]/90 border border-slate-800">
                <div className="text-lg sm:text-xl font-black text-blue-400">256-Bit</div>
          ...
          <div className="lg:col-span-5">
            {currentProduct && (
              <div className="relative rounded-3xl p-5 bg-[#0f172a] border border-blue-500/30 shadow-2xl shadow-black/60 glow-hover transition-all">
                {/* Spotlight Header Bar */}
                <div className="flex items-center justify-between mb-3.5">
                  <div className="flex items-center gap-2">
                    <span className="px-2.5 py-0.5 rounded-full bg-blue-500/15 text-blue-400 border border-blue-500/30 text-[10px] font-extrabold uppercase tracking-wider flex items-center gap-1">
                      <Flame className="w-3 h-3 fill-[#3b82f6]" />
                      Featured Spotlight
                    </span>
                    ...
                    {spotlightProducts.map((_, idx) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all cursor-pointer ${
                          activeIndex === idx ? 'w-6 bg-[#3b82f6]' : 'w-2 bg-slate-700 hover:bg-slate-500'
                        }`}
                        title={`Slide ${idx + 1}`}
                      />
                    ))}
                ...
                >
                  {currentProduct.cover.image ? (
                    ...
                    >
                      <Sparkles className="w-16 h-16 text-[#3b82f6]/40" />
                    </div>
                  )}
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between">
                    <div>
                      <div className="text-xs text-blue-400 font-semibold">{currentProduct.category.name}</div>
                    ...
                    <div className="flex items-center gap-1 bg-slate-950/90 px-2 py-1 rounded-lg border border-slate-700">
                      <Star className="w-3.5 h-3.5 text-[#3b82f6] fill-[#3b82f6]" />
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-800">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-[#3b82f6] hover:bg-[#2563eb] text-black font-extrabold text-xs shadow-md shadow-blue-500/20 transition-all flex items-center gap-1.5 cursor-pointer"
                    >
                      <span>Claim Now</span>
