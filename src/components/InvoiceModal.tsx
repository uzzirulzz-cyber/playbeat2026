...
export const InvoiceModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 overflow-y-auto print:p-0 print:bg-white">
      <div className="bg-[#0f172a] print:bg-white text-slate-100 print:text-black border border-slate-800 print:border-none rounded-3xl w-full max-w-3xl overflow-hidden shadow-2xl flex flex-col max-h-[95vh] print:max-h-none">
        
        {/* Header Actions (hidden on print) */}
        <div className="flex items-center justify-between p-4 bg-[#020617] border-b border-slate-800 print:hidden">
          <div className="flex items-center gap-2">
            <span className="font-bold text-white text-sm">Official Commercial Invoice</span>
            <span className="px-2 py-0.5 rounded-full text-[10px] font-mono bg-blue-400/10 text-[#3b82f6] border border-blue-400/20">
              {order.orderNumber}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="px-3.5 py-1.5 rounded-xl bg-[#3b82f6] hover:bg-[#2563eb] text-slate-950 text-xs font-bold flex items-center gap-1.5 cursor-pointer shadow-md"
            >
        ...
        <div className="p-6 sm:p-8 space-y-6 overflow-y-auto print:p-0" id="printable-invoice">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4 border-b border-slate-800 print:border-slate-300 pb-6">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <div className="w-8 h-8 rounded-xl bg-[#3b82f6] text-black font-black flex items-center justify-center text-base">
                  PB
                </div>
            ...
            <div className="text-left sm:text-right space-y-1">
              <span className="text-2xl font-black text-[#3b82f6] print:text-black font-mono">INVOICE</span>
          ...
          <div className="border border-slate-800 print:border-slate-300 rounded-2xl overflow-hidden">
            <table className="w-full text-left text-xs">
              <thead className="bg-[#020617] print:bg-slate-100 text-slate-400 print:text-slate-700 font-bold border-b border-slate-800 print:border-slate-300">
                <tr>
                  ...
                  return (
                    <tr key={idx} className="hover:bg-slate-900/30 print:hover:bg-transparent">
                      <td className="p-3.5 space-y-1">
                        ...
                        {item.variantName && (
                          <span className="text-[10px] text-blue-400 print:text-blue-700 font-bold">
          ...
          <div className="flex justify-end">
            <div className="w-full sm:w-64 space-y-2 text-xs">
              ...
              <div className="flex justify-between pt-2 border-t border-slate-800 print:border-slate-300 text-sm font-black text-[#3b82f6] print:text-black">
